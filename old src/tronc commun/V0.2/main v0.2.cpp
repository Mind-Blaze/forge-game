...
void initTextures(SDL_Window *window , SDL_Renderer *renderer, SDL_Texture **texture){
  ...
  initTexturesCore(window,renderer,"assets/item/0.bmp",texture,0);
  initTexturesCore(window,renderer,"assets/item/1.bmp",texture,1);
  ...
  initTexturesCore(window,renderer,"assets/item/20100.bmp",texture,58);
  initTexturesCore(window,renderer,"assets/item/21100.bmp",texture,59);
  initTexturesCore(window,renderer,"assets/item/22100.bmp",texture,60);
  initTexturesCore(window,renderer,"assets/item/23100.bmp",texture,61);
  initTexturesCore(window,renderer,"assets/item/24100.bmp",texture,62);
  initTexturesCore(window,renderer,"assets/item/25100.bmp",texture,63);
  initTexturesCore(window,renderer,"assets/item/26100.bmp",texture,64);

  initTexturesCore(window,renderer,"assets/item/20000.bmp",texture,66);
  initTexturesCore(window,renderer,"assets/item/21000.bmp",texture,67);
  initTexturesCore(window,renderer,"assets/item/22000.bmp",texture,68);
  initTexturesCore(window,renderer,"assets/item/23000.bmp",texture,69);
  initTexturesCore(window,renderer,"assets/item/24000.bmp",texture,70);
  initTexturesCore(window,renderer,"assets/item/25000.bmp",texture,71);
  initTexturesCore(window,renderer,"assets/item/26000.bmp",texture,72);
